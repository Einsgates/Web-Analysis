...
# JS extraction approach 1(JS提取方法1)
	jsurl_list_old = []	# Array of link to js as is in html file(与html文件中的js链接的数组)
	jsurl_list = list()	# Array of link to js after getting fully qualified domain name(获得完全合格的域名后指向js的链接数组)
