...
uguay", "2018portugal", "2018spain", "2018morocco", "2018iran", "2018france", "2018iceland", "2018peru", "2018denmark", "2018argentina", "2018iceland", "2018croatia", "2018nigeria", "2018brazil", "2018switzerland", "2018costarica", "2018serbia", "2018germany", "2018mexico", "2018sweden", "2018korearepublic", "2018belgium", "2018panama", "2018tunisia", "2018england", "2018poland", "2018senegal", "2018colombia", "2018japan"].some(function(e) {
    ...
    var d = ["/test2018/index.shtml", "/qiuduitest2018/index.shtml", "/pictest2018/index.shtml", "/2018pictures/"].some(function(e) {
        return window.location.pathname === e || "http://2018.sohu.com/" === window.location.href
    });
    if (d || e()) {
        if ("/test2018/index.shtml" === window.location.pathname || "http://2018.sohu.com/" === window.location.href) b = {
            PAGEID: "home",
            CHANNELID: ""
        };
        else if ("/qiuduitest2018/index.shtml" === window.location.pathname || e()) b = {
            PAGEID: "team",
            CHANNELID: ""
        };
        else if ("/pictest2018/index.shtml" === window.location.pathname || "/2018pictures/" === window.location.pathname) b = {
            PAGEID: "pic",
            CHANNELID: ""
        }
    } else {
        ...
        window.sohu_mp.ext(function(e) {
            b.PAGEID = e.get_pgid(), b.CHANNELID = e.get_news_chn()
        });
        var D; - 1 != b.PAGEID.indexOf("-") ? D = b.PAGEID.split("-")[1] : -1 != b.PAGEID.indexOf("_") && (D = b.PAGEID.split("_")[1])
    }
    d || e() || function(e, d) {
            var b = {
                1001200000: {
                    ...
                    article: {
                        MD5: "ece197db4eee153aa64f218246be8571",
                        ID: 2
                    }
                },
                1001201401: {
            ...
            for (var c in b) d == c && a("article" == D ? "//imp.optaim.com/201612/ece197db4eee153aa64f218246be8571.php?a=" + b[c].article.ID : "tag" == D ? "//imp.optaim.com/201701/6b3ba941976c6f6eb8985975c7b68356.php?a=" + b[c].channel.ID : "//imp.optaim.com/201612/d5710e4e5ad6a4b1195bf96d138279ee.php?a=" + b[c].channel.ID)
        }(b.PAGEID, b.CHANNELID),
        function(e) {
            var a = {
                1001200000: "18",
                1001201401: "18",
            ...
            document.write('<script src="//images.sohu.com/bill/s2012/gates/all/sohuad2012v15.js"><\/script>'), navigator.userAgent.indexOf("MSIE 8.0") > 0 ? (createScript = function(e, a, d, b) {
                try {
                    var D = Math.round((new Date).getTime() / 3e5);
                    a.indexOf(".js") >= 0 && (a = -1 == a.indexOf("?") ? a + "?t=" + D : a + "&t=" + D), document.write('<script src="' + a + '" type="text/javascript"><\/script>')
                } catch (e) {}
            }, document.write('<script type="text/javascript">createScript("sohucsjs","//imp.go.sohu.com/201111/ee4f7cebb2ef825bf6b3c8730c929929_' + a[e] + '.js");<\/script>')) : document.write('<script type="text/javascript">SohuAd.createScript("sohucsjs","//imp.go.sohu.com/201111/ee4f7cebb2ef825bf6b3c8730c929929_' + a[e] + '.js");<\/script>')
        }(b.CHANNELID)
}();