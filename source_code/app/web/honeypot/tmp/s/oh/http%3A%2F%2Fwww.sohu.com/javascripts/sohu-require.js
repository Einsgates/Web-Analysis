...
e(a, function(a) {
        ...
        function r() {
            var a;
            for (k(); A.length;) {
                if (a = A.shift(), null === a[0]) return j(makeError("mismatch", "Mismatched anonymous define() module: " + a[a.length - 1]));
                o(a)
            }
        }
        var s, t, u, v, w, x = {
        ...
        return v = {
            ...
            exports: function(a) {
                return a.usingExports = !0, a.map.isDefine ? a.exports ? a.exports : a.exports = B[a.map.id] = {} : void 0
            },
            module: function(a) {
                        ...
                        if (this.error) this.emit("error", this.error);
                            ...
                            if (this.defining = !0, this.depCount < 1 && !this.defined) {
                                if (isFunction(f)) {
                                    ...
                                    if (this.map.isDefine && (b = this.module, b && void 0 !== b.exports && b.exports !== this.exports ? e = b.exports : void 0 === e && this.usingExports && (e = this.exports)), a) return a.requireMap = this.map, a.requireModules = [this.map.id], a.requireType = "define", j(this.error = a)
                                } else e = f;
            ...
            makeRequire: function(b, d) {
                ...
                return d = d || {}, mixin(e, {
                    ...
                    toUrl: function(a) {
                        var d = a.lastIndexOf("."),
                            e = null;
                        return -1 !== d && (e = a.substring(d, a.length), a = a.substring(0, d)), u.nameToUrl(c(a, b && b.id, !0), e)
                    },
                    defined: function(a) {
            ...
            nameToUrl: function(a, b) {
                ...
                return x.urlArgs ? j + ((-1 === j.indexOf("?") ? "?" : "&") + x.urlArgs) : j
            },
            load: function(a, b) {
                req.load(u, a, b)
            },
            ...
            onScriptError: function(a) {
                var b = q(a);
                return e(b.id) ? void 0 : j(makeError("scripterror", "Script error", a, [b.id]))
            }
...
function() {
    try {
        requirejs.config({
            baseUrl: "//images.sohu.com/bill/s2015/jscript/lib/",
            paths: {
                "sjs/matrix/ad/passion": "//images.sohu.com/bill/s2018/passion/0907/passion.min",
                "sjs/matrix/ad/stat": "//images.sohu.com/bill/s2015/jscript/lib/sjs/matrix/ad/stat"
            }
        })
    } catch (a) {}
}();